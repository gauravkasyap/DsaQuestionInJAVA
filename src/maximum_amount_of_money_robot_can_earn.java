public class maximum_amount_of_money_robot_can_earn {
    ...
    public static void main(String[] args) {
        maximum_amount_of_money_robot_can_earn maximumAmountOfMoneyRobotCanEarn= new maximum_amount_of_money_robot_can_earn();

        int[][] coins= {{0,1,-1},{1,-2,3},{2,-3,4}};
        System.out.println(maximumAmountOfMoneyRobotCanEarn.maximumAmount(coins));
