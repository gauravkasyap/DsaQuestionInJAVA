public class minimum_distance_to_type_a_word_using_two_fingers {
    ...
    public static void main(String[] args) {
          minimum_distance_to_type_a_word_using_two_fingers minimumDistanceToTypeAWordUsingTwoFingers = new minimum_distance_to_type_a_word_using_two_fingers();
          String word ="HAPPY";
        System.out.println(minimumDistanceToTypeAWordUsingTwoFingers.minimumDistance(word));
    }
}
